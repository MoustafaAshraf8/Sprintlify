...
INSERT INTO sprints (sprint_id, project_id, sprint_name, goal, status, start_date, end_date, created_by) VALUES
  ...
  (
    ...
    '00000000-0000-0000-0001-000000000001',
    'Sprint 1',
    'Fix all critical bugs and set up CI pipeline',
    'completed',
    '2026-01-01',
    '2026-01-14',
    '00000000-0000-0000-0000-000000000001'
  ...
  (
    ...
    '00000000-0000-0000-0001-000000000002',
    'Sprint 1',
    'Fix Android bugs and add biometric auth',
    'active',
    '2026-03-01',
    '2026-03-14',
    '00000000-0000-0000-0000-000000000002'
  ...
  (
    ...
    '00000000-0000-0000-0001-000000000003',
    'Sprint 1',
    'Set up staging environment and automated backups',
    'active',
    '2026-03-01',
    '2026-03-14',
    '00000000-0000-0000-0000-000000000003'
...
INSERT INTO tickets (ticket_id, title, description, priority, status, label, assignee_id, reporter_id, project_id, sprint_id) VALUES
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000001',
    '00000000-0000-0000-0001-000000000001',
    '00000000-0000-0000-0005-000000000002'   -- sprint 2 (active)
  ),
  (
    ...
    '00000000-0000-0000-0000-000000000003',
    '00000000-0000-0000-0001-000000000001',
    '00000000-0000-0000-0005-000000000003'   -- sprint 3 (planned)
  ),
  (
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000003',
    '00000000-0000-0000-0001-000000000001',
    '00000000-0000-0000-0005-000000000001'   -- sprint 1 (completed)
  ),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000002',
    '00000000-0000-0000-0001-000000000002',
    '00000000-0000-0000-0005-000000000004'   -- mobile sprint 1 (active)
  ),
  (
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000002',
    '00000000-0000-0000-0001-000000000002',
    '00000000-0000-0000-0005-000000000005'   -- mobile sprint 2 (planned)
  ),
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000003',
    '00000000-0000-0000-0001-000000000003',
    '00000000-0000-0000-0005-000000000006'   -- infra sprint 1 (active)
  ),
  (
